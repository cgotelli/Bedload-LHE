...
filtered_particles = filtered_particles(filtered_particles(:,4) > lim_height*height,:); % 5% of the size away from top border
filtered_particles = filtered_particles(filtered_particles(:,4) < (1-lim_height)*height,:); % 5% of the size away from bottom border
